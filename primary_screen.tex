...
As stated, we settled on \textit{Drosophila} olfactory neurons to demonstrate our miRNA-based screening strategy.
...
We chose Or92a and Or47b because they are expressed in olfactory neurons that innervate prominent, well-separated glomeruli in the antennal lobe (i.e., VA2 and VA1lm) and whose cell bodies are easily distinguishable upon antennal RNA \textit{in situ} hybridization.
...
Before proceeding to miRNA target identification, we verified the miRNA-induced loss of Or47b using RNA \textit{in situ} hybridization with mixed riboprobes against both Or47b and Or92a.

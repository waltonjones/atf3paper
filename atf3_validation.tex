...
Consistent with a role for Atf3 in Or47b expression rather than olfactory neurogenesis, knockdown of Atf3 affects neither OSN morphology, Orco expression, nor Orco localization (\textbf{Fig. \ref{fig:3}A}).
...
Since the other transcription factors implicated in OR expression (e.g., Acj6, Pdm3, Xbp1, Eip93f, etc.) work together as part of a combinatorial code that includes both transcriptional activators and repressors \cite{Brochtrup_Hummel_Alenius_2012}, we guessed that broad antennal over-expression of Atf3 may expand the Or47b expression pattern.
On the contrary, the combination of UAS-Atf3 with the olfactory co-receptor Orco-GAL4 line, which drives expression in most antennal ORNs, has no effect on the Or47b expression pattern (\textbf{Fig. \ref{fig:3}C}).
...
It is also possible that chromatin modifications or other unknown changes arise between ORN birth and final differentiation that somehow prevent the functional binding of ectopic Atf3 to the promoters of other ORs.

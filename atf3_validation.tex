...
We knocked-down the expression of Atf3 in most OSNs using Orco-GAL4 (\emph{Orco-G4\textgreateratf3-IR1}) and performed antennal RNA \emph{in situ} hybridizations using riboprobes specific to several more ORs known to be expressed in the adult antenna (i.e., Or13a, Or22a, Or22b, Or42b, Or43b, Or59b, Or85b, Or98a, and Orco).

...
Finally, because we observed a population of OSNs labeled by Atf3::eGFP and not by Or47b-G4\textgreater{}TdTomato (\textbf{Fig. \ref{fig:3}B}), we asked whether Atf3 is involved in the expression of other ORs.
We knocked-down the expression of Atf3 in most OSNs using Orco-GAL4 (\emph{Orco-G4\textgreater{}atf3-IR1}) and performed antennal RNA \emph{in situ} hybridizations using riboprobes specific to several more ORs known to be expressed in the adult antenna (i.e., Or13a, Or22a, Or22b, Or42b, Or43b, Or59b, Or85b, Or98a, and Orco).
